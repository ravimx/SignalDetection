...
for i = initial:total_images
    ...
    %% Hiding This
    % To find Total Red/Green/Yellow objects Detected
        subplot(1,3,1);
        imshow(f);
...
clear xcRed xcYellow xcGreen RedCount YellowCount GreenCount Redxcfinal Greenrediusfinal Yellowrediusfinal Redxcfinal Greenxcfinal Yellowxcfinal rediusRed rediusGreen rediusYellow i j DTConfidance grecount GreenBulbMetric GreenBMetric Greenmetric GreenThre index RedBMetric RedBulbMetric YellowBMetric YellowBulbMetric redcount Redmetric Redrediusfinal RedThre sliceGreenImage sliceRedImage sliceYellowImage YellowThre Yellowmetric 
clc;
